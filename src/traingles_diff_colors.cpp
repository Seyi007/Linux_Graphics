...
// Fragment Shader source (orange color)
...
int main() {
    ...
    // Check for fragment (yellow) compilation errors
    ...
    // ADD HERE — define your vertex data once, not inside the loop
    float vertices[] = {
        // first triangle (left)
        -0.9f, -0.5f, 0.0f,  // left
    ...
    // Now for the second triangle, we can reuse the same shader program and VAO
    // but we need to create a new VBO and VAO for the second triangle's vertices
